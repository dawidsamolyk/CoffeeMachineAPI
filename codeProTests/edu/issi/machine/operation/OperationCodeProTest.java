...
public class OperationCodeProTest {
	...
	public void testExecute_fixture_1()
		...
		assertEquals("[ERROR] Nie podano podzespolu lub skladnika dla tej operacji!", result.getCompensatedStatus());
	}
	 ...
	 */
	@Test
	public void testSetIngredient_fixture_1()
		throws Exception {
		Operation fixture2 = getFixture();
	 ...
	 */
	@Test
	public void testSetSubassembly_fixture_1()
		throws Exception {
		Operation fixture2 = getFixture();
