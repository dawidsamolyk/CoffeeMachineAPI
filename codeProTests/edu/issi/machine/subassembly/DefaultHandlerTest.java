...
/**
 * The class <code>DefaultHandlerTest</code> contains tests for the class <code>{@link DefaultHandler}</code>.
 *
...
public class DefaultHandlerTest {
	 ...
	 * @generatedBy CodePro at 27.11.14 17:52
	 */
	public DefaultHandler getFixture()
		throws Exception {
		if (fixture == null) {
	...
	public void testRun_fixture_1()
		throws Exception {
		DefaultHandler fixture2 = getFixture();
		...
		//       at edu.issi.machine.subassembly.DefaultHandler.run(DefaultHandler.java:12)
	}
