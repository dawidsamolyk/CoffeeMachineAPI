...
/**
 * The class <code>OrderedElementsListTest</code> contains tests for the class
 * <code>{@link OrderedElementsList}</code>.
 *
...
public class OrderedElementsListTest {
     ...
     * @generatedBy CodePro at 27.11.14 17:52
     */
    public OrderedElementsList getFixture() throws Exception {
	if (fixture == null) {
     ...
     */
    @Test
    public void testOrderedElementsList_1() throws Exception {
    ...
    public void testGetElementAt_fixture_1() throws Exception {
	OrderedElementsList fixture2 = getFixture();
	int index = 0;
     ...
     */
    @Test(expected = java.util.NoSuchElementException.class)
    public void testGetElementAt_fixture_2() throws Exception {
	OrderedElementsList fixture2 = getFixture();
	int index = 1;
     ...
     */
    @Test(expected = java.util.NoSuchElementException.class)
    public void testGetElementAt_fixture_3() throws Exception {
	OrderedElementsList fixture2 = getFixture();
	int index = 7;
