...
/**
 * The class <code>MachineConfigurationTest</code> contains tests for the class <code>{@link MachineConfiguration}</code>.
 *
...
public class MachineConfigurationCodeProTest {
	/**
	 * Run the MachineConfiguration(List<Subassembly>,List<Product>) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 27.11.14 17:52
	...
	public void testMachineConfiguration_1()
		throws Exception {
	...
	/**
	 * Run the MachineConfiguration(List<Subassembly>,List<Product>,Properties) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 27.11.14 17:52
	 */
	@Test(expected = java.lang.IllegalStateException.class)
	public void testMachineConfiguration_2()
		throws Exception {
		List<Subassembly> subassemblies = null;
		List<Product> products = null;
