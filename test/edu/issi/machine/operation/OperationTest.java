...
public class OperationTest {
	...
	public void shouldGiveResponseAfterExecution() throws Exception {
		...
		OperationState state = operation
				.setIngredient(IngredientTest.mockIngredient())
	...
	public void shouldGiveErrorResponseWhenOnlyIngredientSetted()
			throws Exception {
		Operation operation = mockOperation();
		OperationState state = operation.setIngredient(
				IngredientTest.mockIngredient()).execute();
	...
	public void shouldExecuteValidlyWhenIngredientAndSubassemblySetted()
			throws Exception {
		Operation operation = mockOperation();
		Subassembly subassembly = new Subassembly(new Identity(10),
				mockOperation());
