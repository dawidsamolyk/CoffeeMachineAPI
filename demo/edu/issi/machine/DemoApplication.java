...
public class DemoApplication {
    ...
    public static List<Ingredient> getDemoIngredients() throws InvalidAttributeIdentifierException {
    ...
    public static Ingredient getDemoTee() throws InvalidAttributeIdentifierException {
