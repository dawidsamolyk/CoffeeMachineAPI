...
public class MachineConfiguration {
	 ...
	 */
	public MachineConfiguration(List<Subassembly> subassemblies,
			List<Product> products) throws IllegalStateException {
	...
	public final void ensureValidity() throws IllegalStateException {
		...
		Validator.throwExceptionWhenEmpty(subassemblies, message
				+ "podzespo³ów!");
